...
/*-----------------------------------------------
              @(target):= _tsp.so
  ------------------------------------------------*/
#define SWIG_init    init_tsp

#define SWIG_name    "_tsp"
...
SWIGINTERN PyObject *_wrap_runTSP(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOO:runTSP",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__vectorT_double_std__allocatorT_double_t_t,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "runTSP" "', argument " "1"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runTSP" "', argument " "1"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  arg1 = reinterpret_cast< std::vector< double,std::allocator< double > > * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "runTSP" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_std__vectorT_int_std__allocatorT_int_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "runTSP" "', argument " "3"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runTSP" "', argument " "3"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  ...
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "runTSP" "', argument " "4"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  if (!argp4) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runTSP" "', argument " "4"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  ...
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "runTSP" "', argument " "5"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  if (!argp5) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runTSP" "', argument " "5"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  ...
  if (!SWIG_IsOK(res6)) {
    SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "runTSP" "', argument " "6"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  if (!argp6) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "runTSP" "', argument " "6"" of type '" "std::vector< int,std::allocator< int > > &""'"); 
  }
  arg6 = reinterpret_cast< std::vector< int,std::allocator< int > > * >(argp6);
  runTSP(*arg1,arg2,*arg3,*arg4,*arg5,*arg6);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"runTSP", _wrap_runTSP, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
